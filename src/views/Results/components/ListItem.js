const ListItem = ({ id, primaryImage, titleText}) => (
    <div key={id} style={{ minWidth: 650 }} className="flex flex-row w-full mt-16">
        ...
        <div className="w-5/6 flex flex-col items-start py-1 px-5">
            ...
            <div className="flex h-full items-end">
                <button className="border-2 border-rose rounded-md w-48 h-10 text-xl text-rose hover:bg-rose hover:text-white">Ver más</button>
            </div>
        </div>
    </div>
)
